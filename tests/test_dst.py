...
@pytest.mark.parametrize(("specific_params"),
                         [grid_params, sensor_params])
...
def test_dst_lengths_grid(specific_params, dst_start, dst_end, expected_length):
    ...
    gp = GP(**test_params, **specific_params)
    gp.simulate()
